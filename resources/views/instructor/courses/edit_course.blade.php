    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form class="row g-3" action="{{ route('update.course') }}" method="post" id="myForm"
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea name="prerequisites" class="form-control" id="mytextarea" placeholder="Prerequisites ..." rows="3">{!! $course->prerequisites !!}</textarea>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="input1" class="form-label">Course Description</label>
                        <textarea name="description" class="form-control" id="mytextarea" rows="3">{!! $course->description !!}</textarea>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="bestseller" value="1"
                                    {{ $course->bestseller == '1' ? 'checked' : '' }} id="flexCheckDefault">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="featured" value="1"
                                    {{ $course->featured == '1' ? 'checked' : '' }} id="flexCheckDefault">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="highestrated" value="1"
                                    {{ $course->highestrated == '1' ? 'checked' : '' }} id="flexCheckDefault">
