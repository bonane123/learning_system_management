                ...
                <div class="col-lg-8 pb-5">
                    <div class="course-details-content-wrap pt-90px">
                        ...
                        <div class="course-overview-card">
                            ...
                            <p class="fs-15 pb-2">{!! Str::limit($course->description, 500) !!}</p>
                            <div class="collapse" id="collapseMore">
                                {!! Str::substr($course->description, 500) !!}
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($relatedCourses as $related)
                                    <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                        ...
                                        <div class="media-body">
                                            <h5 class="fs-15"><a
                                                    href="course-details.html">{{ $related->course_name }}</a></h5>
                                            ...
                                            <p class="text-black font-weight-semi-bold lh-18 fs-15">
                                                {{ $related->selling_price }} <span
                                                    class="before-price fs-14">{{ $related->discount_price }}</span></p>
                                        </div>
                                    </div><!-- end media -->
                                @endforeach
