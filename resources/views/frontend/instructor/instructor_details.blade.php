                ...
                <div class="media media-card align-items-center pb-4">
                    <div class="media-img media--img media-img-md rounded-full">
                        <img class="rounded-full"
                            ...
                            data-src="{{ !empty($instructor->photo) ? url('upload/instructor_images/' . $instructor->photo) : url('upload/no_image.jpg') }}"
                            alt="Avatar image"" alt="Student thumbnail image">
                    </div>
                    <div class="media-body">
                        <h2 class="section__title fs-30">{{ $instructor->username }}</h2>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @if ($course->discount_price == null)
                                        <p class="card-price text-black font-weight-bold">
                                            RWF {{ $course->selling_price }} </p>
                                    @else
                                        <p class="card-price text-black font-weight-bold">
                                            RWF {{ $course->discount_price }} <span
            ...
            <div id="tooltip_content_1{{ $item->id }}">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <p class="card-text pt-1 fs-14 lh-22">{!! Str::limit($item->prerequisites, 150) !!}</p>
